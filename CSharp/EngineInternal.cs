...
namespace Swolescript
{
    ...
    public static class EngineInternal
    {
        ...
        public struct Vector3
        {
            ...
            public static Vector3 operator *(Quaternion q, Vector3 v) => SwoleScript.Engine.Mul(q, v);
        ...
        public struct Quaternion
        {
            ...
            public static Quaternion operator *(Quaternion qA, Quaternion qB) => SwoleScript.Engine.Mul(qA, qB);

            public static Quaternion Euler(Vector3 eulerAngles) => SwoleScript.Engine.Quaternion_Euler(eulerAngles);
            public static Quaternion Euler(float x, float y, float z) => SwoleScript.Engine.Quaternion_Euler(x, y, z);
        ...
        public struct Matrix4x4
        {
            ...
            public static Matrix4x4 operator *(Matrix4x4 mA, Matrix4x4 mB) => SwoleScript.Engine.Mul(mA, mB);

            public static Matrix4x4 TRS(Vector3 position, Quaternion rotation, Vector3 scale) => SwoleScript.Engine.Matrix4x4_TRS(position, rotation, scale);
        ...
        public struct GameObject
        {
            ...
            public string name => SwoleScript.Engine.GetName(instance);

            public static GameObject Create(string name = "") => SwoleScript.Engine.GameObject_Create(name);

            public static GameObject Instantiate(GameObject referenceObject) => SwoleScript.Engine.GameObject_Instantiate(referenceObject);

            public GameObject Instantiate() => Instantiate(this);

            public static void Destroy(GameObject gameObject, float timeDelay = 0) => SwoleScript.Engine.GameObject_Destroy(gameObject, timeDelay);
        ...
        public struct Transform
        {
            ...
            public void SetParent(Transform parent, bool worldPositionStays = true) => SwoleScript.Engine.Transform_SetParent(this, parent, worldPositionStays);
            ...
            public Transform parent => SwoleScript.Engine.Transform_GetParent(this);

            public Vector3 position
            {
                get => SwoleScript.Engine.GetWorldPosition(instance);
                set => SwoleScript.Engine.SetWorldPosition(instance, value);
            }

            public Quaternion rotation
            {
                get => SwoleScript.Engine.GetWorldRotation(instance);
                set => SwoleScript.Engine.SetWorldRotation(instance, value);
            }

            public Vector3 localPosition
            {
                get => SwoleScript.Engine.GetLocalPosition(instance);
                set => SwoleScript.Engine.SetLocalPosition(instance, value);
            }

            public Quaternion localRotation
            {
                get => SwoleScript.Engine.GetLocalRotation(instance);
                set => SwoleScript.Engine.SetLocalRotation(instance, value);
            }

            public Vector3 localScale
            {
                get => SwoleScript.Engine.GetLocalScale(instance);
                set => SwoleScript.Engine.SetLocalScale(instance, value);
            }
        ...
        public struct TileSet
        {
            ...
            public int TileCount => SwoleScript.Engine.GetTileCount(instance);

            public Tile this[int tileIndex] => SwoleScript.Engine.GetTileFromSet(instance, tileIndex);
