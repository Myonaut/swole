...
namespace Swolescript
{
    ...
    public class ExecutionStack : IDisposable
    {
        ...
        public void EvaluateLayer(ExecutionLayer layer)
        {
        ...
        public void Evaluate()
        {
            ...
            EvaluateLayer(ExecutionLayer.EarlyUpdate);
            EvaluateLayer(ExecutionLayer.Update);

        }

        public void LateEvaluate() => EvaluateLayer(ExecutionLayer.LateUpdate);
