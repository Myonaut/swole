...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public Vector3 GetTangent (int index) {
            return transform == null ? localTangents[index] : MathUtility.TransformDirection (localTangents[index], transform, space);
        }

        public Vector3 GetNormal (int index) {
            return transform == null ? localNormals[index] : MathUtility.TransformDirection (localNormals[index], transform, space);
        }

        public Vector3 GetPoint (int index) {
            return transform == null ? localPoints[index] : MathUtility.TransformPoint (localPoints[index], transform, space);
        }
