...
namespace SplineMesh {
    ...
    public class MeshBender : MonoBehaviour {
        ...
        private bool alwaysSetFilterMesh;
        public bool AlwaysSetFilterMesh
        {
            get => alwaysSetFilterMesh;
            set => alwaysSetFilterMesh = value;
        }
        ...
        public void SetIntervalNormalized(Spline spline, float normalizedIntervalStart, float normalizedIntervalEnd = 0f)
        {
            ...
            float intervalStart = length * normalizedIntervalStart;
